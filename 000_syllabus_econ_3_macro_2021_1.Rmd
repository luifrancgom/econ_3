...
- Semester: 3
- Block: 1 (January 25 – March 28, 2021) 
...
tibble::tibble(Week = c(1:9, 9),
       Material       = c("[@blanchard_macroeconomics_2017]", 
                          "[@lora_tecnicas_2016]", 
                          rep("[@blanchard_macroeconomics_2017]", times = 7),
                          "[@carrasquilla-barrera_informe_2020]"),
       Chapter        = c("1 & 2", "2", "3", "4", "5", "6", "17", "18", "19", "2"),
       `Initial page` = c(26, 1, 70, 90, 112, 134, 372, 392, 414, 17),
       `Final page`   = c(63, 31, 89, 107, 132, 153, 391, 413, 433, 43)) %>%
  dplyr::mutate(`Number of pages` = (`Final page` - `Initial page`) + 1) %>% 
  knitr::kable()
```
...
- January 26
    ...
    + __Virtual meeting Presentation Syllabus__
        ...
        + __Prerequisites__:
            + Review the course program in advance, which can be downloaded by following the route _Primer corte 30% > Learning Resources > Support material > Presentations > 000_syllabus_econ_3_macro_2021_1_
...
- March 22
    ...
    + __Final Exam Opening__
        ...
        + __Prerequisites__:
            ...
            + Read and review [@carrasquilla-barrera_informe_2020, Chapter 2]
...
- [@carrasquilla-barrera_informe_2020, Chapter 2]
