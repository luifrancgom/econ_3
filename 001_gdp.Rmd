...
- **Product**: refers to what we are trying to measure as a result of a production process [@lequillerUnderstandingNationalAccounts2014a].

- **Domestic**: indicates that the production to be taken into account is the one that is carried within a certain territory clearly delimited [@lequillerUnderstandingNationalAccounts2014a].

- **Gross**: It means that depreciation is not deducted (in economy it is called consumption of fixed capital). In other words, the decrease in the value of the assets due to physical deterioration, foreseeable wear or accidental damage is not deducted [@lequillerUnderstandingNationalAccounts2014a].
