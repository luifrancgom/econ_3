...
- This presentation is based on [@blanchardMacroeconomics2017a, Chapter 4]
...
- **The rate**:
    ...
    + In the link [**http://www.banrep.gov.co/es/estadisticas/tasas-interes-politica-monetaria**](http://www.banrep.gov.co/es/estadisticas/tasas-interes-politica-monetaria) on August 10, 2020 it was pointed out that:
...
```
    ...
    + Also the *"tasa de intervención de política monetaria"* on August 10, 2020 it was `r scales::percent(i_t, accuracy = 0.01)` 
...
- If $i_t =$ `r i_t` (`r scales::percent(i_t, accuracy = 0.01)`) and also it is an **annual effective overdue** interest rate then this means the following:
...
ibr_daily <- read_csv(file = "005_ibr_plazo_overnight_nominal.csv") %>% 
...
- To the __[R Core Team](https://www.r-project.org/contributors.html)__, the creators of __[RStudio IDE](https://rstudio.com/products/rstudio/)__ and the authors and maintainers of the packages __[tidyverse](https://CRAN.R-project.org/package=tidyverse)__, __[tidyquant](https://CRAN.R-project.org/package=tidyquant)__, __[lubridate](https://CRAN.R-project.org/package=lubridate)__, __[readxl](https://CRAN.R-project.org/package=readxl)__ and __[tinytex](https://CRAN.R-project.org/package=tinytex)__ for allowing me to access these tools without paying for a license
